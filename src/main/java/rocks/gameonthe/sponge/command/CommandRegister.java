  ...
  public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
    if (src instanceof Player) {
      ...
      player.sendMessage(Text.of(
          "Please use https://discord.gg/0meBvxkpFe3bXh2f to join the Rebelcraft Discord."));
      player.sendMessage(Text.of("Your registration code is: " + code));
      player.sendMessage(
          Text.of("Please follow the instructions in the message from the Rebelcraft Bot."));
